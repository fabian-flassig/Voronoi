...
local function dist_point_to_point (p1, p2)
    ...
    return PYTHAGORAS(p1.x-p2.x, p1.y-p2.y,2)
end
...
local function intersection (p1, p2, l)
    ...
    local p_x, p_y, res_y = p1.x, p1.y, nil
...
local function cut_edges (edges, border_left, border_right, border_top, border_bottom)
    ...
    local corner_angles = {
        math.pi,
        math.atan(border_right-center_x,border_bottom-center_y),   -- Top Right
        math.atan(border_right-center_x,border_top-center_y),      -- Bottom Right
        math.atan(border_left-center_x,border_top-center_y),       -- Bottom Left
        math.atan(border_left-center_x,border_bottom-center_y),    -- Top Left
    }
...
local function angle_between_three_points ( p1, p2, p3 )
	...
	local A = PYTHAGORAS(p1.x-p2.x, p1.y-p2.y)
	local B = PYTHAGORAS(p2.x-p3.x, p2.y-p3.y)
	local C = PYTHAGORAS(p3.x-p1.x, p3.y-p1.y)
...
local function dist_point_to_edge (point, edge)
	...
	return PYTHAGORAS(point.x-closest_x, point.y-closest_y)
end
